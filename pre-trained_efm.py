...
Training_Rec_path = os.path.join(root, 'test.rec')   # Aug_train data
Testing_Rec_path = os.path.join(root, 'lfw_data.rec')     # Org_test data
...
#net.load_params("%s/EFM_RES.params" % sys.argv[2], ctx=devs)
...
for epoch in range(200):
    ...
    paramfile = "efm_res_TL-%04d.params" %(epoch)
